  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        ...
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-U64FBYWN.js");
        break;
      case "zhHK" /* ZH_HK */:
        locales2 = await import("./zh-HK-LGAT7ASQ.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-YHTMJREV.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-NL65TAEO.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-LEPDW6QR.js");
        break;
      case "jaJP" /* JA_JP */:
      ...
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-DPFO4AI6.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "2b15443";
        const gitBranch = "dev";
        const buildTime = "2026-06-04T12:22:02.773Z";
