...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-ISQ4WGF3.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-2HTDCTHO.js");
        break;
      case "zhHK" /* ZH_HK */:
        locales2 = await import("./zh-HK-WE3MBCBM.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-SOE2PUWF.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-NTHVT6DX.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-WM66JCCD.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-7ORN4FEB.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-LWDR2CN3.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-BB6YQUCS.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-2LYLQRHI.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-YONK4WDO.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-U3NYHV2D.js");
        break;
      case "ptBR" /* PT_BR */:
        locales2 = await import("./pt-BR-6TBXOALU.js");
        break;
      case "deDE" /* DE_DE */:
        locales2 = await import("./de-DE-V4QMULBX.js");
        break;
      case "itIT" /* IT_IT */:
        locales2 = await import("./it-IT-R4AZ6GB2.js");
        break;
      case "idID" /* ID_ID */:
        locales2 = await import("./id-ID-MMYX2DFF.js");
        break;
      case "plPL" /* PL_PL */:
        locales2 = await import("./pl-PL-2FXHRK3L.js");
        break;
      case "arSA" /* AR_SA */:
        locales2 = await import("./ar-SA-EXSQEIOS.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-JJIS5AOJ.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "6b96f90";
        const gitBranch = "dev";
        const buildTime = "2026-06-01T12:33:55.919Z";
