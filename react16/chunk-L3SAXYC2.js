...
var SheetsSortUIController = class extends RxDisposable {
  constructor(_commandService, _menuManagerService, _dialogService, _layoutService, _uiPartsService, _sheetRenderService, _localeService, _sheetsSortUIService, _injector, _componentManager, _iconManager) {
    super();
    __publicField(this, "_commandService", _commandService);
...
SheetsSortUIController = __decorateClass([
  ...
  __decorateParam(10, Inject(IconManager))
