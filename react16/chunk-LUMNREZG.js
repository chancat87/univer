...
var FindReplaceController = class extends RxDisposable {
  constructor(_univerInstanceService, _menuManagerService, _shortcutService, _commandService, _findReplaceService, _dialogService, _layoutService, _localeService, _componentManager, _iconManager) {
    super();
    __publicField(this, "_univerInstanceService", _univerInstanceService);
    __publicField(this, "_menuManagerService", _menuManagerService);
...
FindReplaceController = __decorateClass([
  ...
  __decorateParam(9, Inject(IconManager))
