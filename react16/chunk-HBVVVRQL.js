...
var ConditionalFormattingMenuController = class extends Disposable {
  constructor(_injector, _iconManager, _menuManagerService) {
    super();
    __publicField(this, "_injector", _injector);
...
var SheetsDataValidationUIController = class extends RxDisposable {
  constructor(_injector, _componentManger, _iconManager, _dataValidatorRegistryService) {
    super();
    __publicField(this, "_injector", _injector);
...
SheetsDataValidationUIController = __decorateClass([
  ...
  __decorateParam(2, Inject(IconManager)),
  __decorateParam(3, Inject(DataValidatorRegistryService))
...
var SheetsFilterUIDesktopController = class extends SheetsFilterUIMobileController {
  constructor(_injector, _componentManager, _iconManager, _sheetsFilterPanelService, _sheetCanvasPopupService, _sheetsFilterService, _localeService, _shortcutService, _commandService, _menuManagerService, _contextService, _messageService, sheetsRenderService, renderManagerService) {
...
SheetsFilterUIDesktopController = __decorateClass([
  ...
  __decorateParam(1, Inject(ComponentManager)),
  __decorateParam(2, Inject(IconManager)),
  __decorateParam(3, Inject(SheetsFilterPanelService)),
  __decorateParam(4, Inject(SheetCanvasPopManagerService)),
  __decorateParam(5, Inject(SheetsFilterService)),
  __decorateParam(6, Inject(LocaleService)),
  __decorateParam(7, IShortcutService),
  __decorateParam(8, ICommandService),
  __decorateParam(9, IMenuManagerService),
  __decorateParam(10, IContextService),
  __decorateParam(11, IMessageService),
  __decorateParam(12, Inject(SheetsRenderService)),
  __decorateParam(13, IRenderManagerService)
