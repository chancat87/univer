...
var DocElementRegistry = class {
  constructor() {
    __publicField(this, "_paragraphsBySegment", /* @__PURE__ */ new Map());
  }
  /**
   ...
   */
  getParagraphKey(segmentId, body, paragraphIndex) {
    var _a;
    const paragraph = (_a = body.paragraphs) == null ? void 0 : _a[paragraphIndex];
    if (!paragraph) {
   ...
   */
  resolveParagraphStartIndex(segmentId, key) {
   ...
   */
  syncParagraph(segmentId, key, body) {
    var _a, _b;
    const startIndex = this.resolveParagraphStartIndex(segmentId, key);
    const paragraphIndex = (_b = (_a = body.paragraphs) == null ? void 0 : _a.findIndex((paragraph) => paragraph.startIndex === startIndex)) != null ? _b : -1;
    if (paragraphIndex < 0) {
   ...
   * @returns {void}
   */
  beforeTextEdit(segmentId, startOffset, endOffset, insertLength) {
...
var FDocBody = class {
  constructor(_documentDataModel, _commandService, _registry, _segmentId = "") {
    ...
    __publicField(this, "_registry", _registry);
  ...
  _executeTextX(range, textX, insertLength, trackTextEdit = true) {
    if (trackTextEdit) {
